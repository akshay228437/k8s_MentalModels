...
# Example: Network Policy Mental Model

Think of a NetworkPolicy as a firewall attached to Pods.
...
What traffic is controlled?

Who is allowed?

What is denied by implication?
```
...
# Example: Deployment Mental Model

Think of a Deployment as a desired state manager.
...
The Deployment continuously reconciles reality with the desired state.
